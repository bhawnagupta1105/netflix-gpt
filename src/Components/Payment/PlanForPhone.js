          ...
          <div className="flex m-auto justify-between w-full">
            <div className="pr-[2%] md:pr-[4%]">
              <button
                ...
                className={`rounded-3xl border-2 md:border-4 border-gray-500 p-1 pb-11 md:p-3 lg:p-6 xl:p-10   ${
                  activePlan === "plan1"
                    ? "text-white bg-gradient-to-br from-blue-950 via-sky-600 to-teal-600"
                    : ""
                }`}
              >
                <b className="text-sm md:text-2xl md:mr-10 ">Premium</b>
                <p className="text-xs md:text-lg md:mr-10 md:mb-10">4K + HDR</p>
              </button>
            </div>
            <div className="pr-[2%] md:pr-[4%]">
              <button
                ...
                className={` rounded-3xl border-2 md:border-4 border-gray-500 p-1 pb-11 md:p-3 lg:p-6 xl:p-10 ${
                  activePlan === "plan2"
                    ? "text-white bg-gradient-to-br from-blue-900 via-indigo-700 to-teal-900"
                    : ""
                }`}
              >
                <b className="text-sm md:text-2xl p-0 md:mr-10">Standard</b>
                <p className="text-sm md:text-lg md:mr-10 md:mb-10">1080p</p>
              </button>
            </div>
            <div className="pr-[2%] md:pr-[4%]">
              <div className=" pb-0 -mt-9">
                <div className=" text-xs  flex justify-center  md:text-base rounded-t-lg border-2 md:border-4 border-gray-500 text-white bg-gradient-to-br from-cyan-800 to-emerald-500">
                  Most Popular
                </div>
                <button
                  ...
                  className={` rounded-b-3xl rounded-t-md border-2 md:border-4 border-gray-500 p-1 pb-11 md:p-3 lg:p-6 xl:p-10 ${
                    activePlan === "plan3"
                      ? "text-white bg-gradient-to-br from-sky-800 via-blue-900 to-emerald-500"
                      : ""
                  }`}
                >
                  <b className="text-sm md:text-2xl p-4 md:p-6 md:mr-10">
                    Basic
                  </b>
                  <p className="text-sm md:text-lg md:mr-10 md:mb-10">720p</p>
                </button>
              </div>
            </div>
            ...
            <div className="">
              <button
                ...
                className={` rounded-3xl border-2 md:border-4 border-gray-500 p-1 pb-11 md:p-3 lg:p-6 xl:p-10 ${
                  activePlan === "plan4"
                    ? "text-white bg-gradient-to-br from-sky-950 via-blue-900 to-cyan-600"
                    : ""
                }`}
              >
                <b className="text-sm md:text-2xl p-2 md:p-3 md:mr-10">
                  Mobile
                </b>
                <p className="text-sm md:text-lg md:mr-10 md:mb-10">480p</p>
              </button>
            </div>
          </div>
