      ...
      <div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex">
            ...
            />
            <img
              className="h-20 w-29 rounded-2xl"
              src="https://w7.pngwing.com/pngs/181/728/png-transparent-diners-club-international-credit-card-discover-card-logo-payment-credit-card-blue-text-plus.png"
              alt="dinnersClub"
            />
          </div>
          ...
          <br />
          <div
            className="border-4 border-neutral-300 bg-gray-300 hover:bg-gray-400 rounded-lg p-3 text-xl flex"
            onClick={payment}
          >
          ...
          <div>
            <span className="text-xl text-slate-600">
              Any payment above ₹ 2000 shall need additional authentication. By
              checking the checkbox below, you agree to our Terms of Use,
            ...
            <span className="text-xl text-slate-600">
              ...
              membership fee (currently ₹199/month) to your payment method until
            ...
            <div className="mt-4">
              ...
              {showCheckboxAlert && (
                <div className="text-red-500 text-lg mt-2">
                  You must acknowledge that you have read and agree to the Terms
                  of Use to continue.
                </div>
              )}
            </div>
        ...
        <Link className="flex underline text-blue-400" to="#">
          Learn More
        </Link>
      </div>
    </div>
